...
insert into account values ('Downtown','A-101',500), ('Mianus','A-215',700) ,('Perryridge','A-102',400), ('Round Hill','A305',350), ('Brighton','A-201',900), ('Redwood','A-222',700), ('Brighton','A-217',750);
...
insert into depositor values ('C-226', 'A-101'), ('C-201', 'A-215'), ('C-211', 'A-102'), ('C-220', 'A-305'), ('C-226', 'A-201'), ('C101', 'A-217'),('C-215', 'A-222');

insert into borrower values ('C-101', 'L-17'), ('C-201', 'L-23'), ('C-211', 'L-15'), ('C-226', 'L-14'), ('C-212', 'L-93'), ('C-201', 'L11'), ('C-222', 'L-17'), ('C-225', 'L-16');


Select * from Table1 inner join Table2 on Table1.attribute=Table2.attribute;


Select * from ((Table1 inner join Table2 on Table1.attribute=Table2.attribute) inner join Table 3 on Table3.attribute = Table1/2.attribute);